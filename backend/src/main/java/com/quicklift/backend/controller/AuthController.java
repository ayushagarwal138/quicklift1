...
@CrossOrigin(origins = {"http://localhost:5173", "http://localhost:5174", "http://localhost:3000", "https://quicklift.netlify.app"})
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody UserRegistrationRequest registrationRequest) {
        try {
            ...
            if (roleStr != null) {
                try {
                    user.setRole(com.quicklift.backend.model.UserRole.valueOf(roleStr.toUpperCase()));
                } catch (IllegalArgumentException e) {
                    user.setRole(com.quicklift.backend.model.UserRole.USER);
                }
            } else {
                user.setRole(com.quicklift.backend.model.UserRole.USER);
            }
            ...
            if (registeredUser.getRole() == com.quicklift.backend.model.UserRole.DRIVER) {
